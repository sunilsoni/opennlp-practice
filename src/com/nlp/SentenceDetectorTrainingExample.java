...
public class SentenceDetectorTrainingExample {
	 ...
	 * directory "custom_models". The training data used is
	 * "trainingDataSentences.txt". Training data contains a sentence per line in
	 * the text file.
	 * 
	 * @throws IOException
	 */
	public void trainSentDectectModel() throws IOException {
		...
		// train the model
		SentenceModel sentdetectModel = SentenceDetectorME.train("en",
